...
map.BLEAF_CO                  = {'pa', 1  , 1, 'YQE'  ,  'kgC/pl' , 'kgC/m2'  };
map.BROOT_CO                  = {'pa', 1  , 1, 'YQE'  ,  'kgC/pl' , 'kgC/m2'  };
map.BSTORAGE_CO               = {'pa', 1  , 1, 'YQE'  ,  'kgC/pl' , 'kgC/m2'  };
map.BSAPWOODA_CO              = {'pa', 1  , 1, 'QE'   ,  'kgC/pl' , 'kgC/m2'  }; %**
map.BSAPWOODB_CO              = {'pa', 1  , 1, 'QE'   ,  'kgC/pl' , 'kgC/m2'  }; %**
map.BALIVE_CO                 = {'pa', 1  , 1, 'QE'   ,  'kgC/pl' , 'kgC/m2'  }; %**
map.BDEAD_CO                  = {'pa', 1  , 1, 'QE'   ,  'kgC/pl' , 'kgC/m2'  }; %**
...
map.FMEAN_LEAF_RESP_CO         = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2/yr'  };
map.FMEAN_ROOT_RESP_CO         = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2/yr'  };
map.FMEAN_LASSIM_RESP_CO       = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2/yr'  };
map.FMEAN_LEAF_MAINTENANCE_CO  = {'pa', 1  , 1, 'I',   'kgC/pl'    , 'kgC/m2'     };
map.FMEAN_ROOT_MAINTENANCE_CO  = {'pa', 1  , 1, 'I',   'kgC/pl'    , 'kgC/m2'     };
map.FMEAN_LAI_CO               = {'pa', 0  , 1, 'I',   'm2l/m2g'   , 'm2l/m2g'    };
map.FMEAN_LEAF_DROP_CO         = {'pa', 1  , 1, 'I',   'kgC/pl'    , 'kgC/m2'     };
map.FMEAN_GPP_CO               = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2/yr'  };
map.FMEAN_NPP_CO               = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2/yr'  };
map.FMEAN_PLRESP_CO            = {'pa', 1  , 1, 'I',   'kgC/pl/yr' , 'kgC/m2'     };
