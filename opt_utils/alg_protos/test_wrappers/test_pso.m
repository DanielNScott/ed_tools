...
for niter_num = 1:length(niter_set)
    ...
    for i = 1:n_repetitions
       ...
       % Find the minimum.
       [sol, trace] = particle_swarm(bnds,niter,nps,fn);

       %opts = optimoptions('particleswarm','MaxIter',niter,'SwarmSize',nps);
       %sol = particleswarm(fn,2,bnds(:,1),bnds(:,2), opts);       
