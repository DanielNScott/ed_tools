function [solution,trace,iter] = nelder_mead_v2(params,smplx,cnstr,f,term_val,varargin)
...
while iter < iter_lim
   ...
   obj_s = f(smplx);                                         % Get objective vals of vertices.
   ...
   obj_r = f(pt_r);                                         % Objective val. of reflected pt.
   ...
   case(4) % Consider expansion
      ...
      obj_e = f(pt_e);                                      % Evaluate the obj. there.
   ...
   case(5) % Consider Shrinking or Contracting
      ...
      obj_c = f(pt_c);                                      % Get the obj. of contracted pt.
      obj_w = f(smplx(end,:));                              % Get the "worst" obj in simplex
