...
%  - Sphere          Runs an optimization on the sphere function
%------------------------------------------------------------------------------------------%
...
{  'hourly' , 'NEE'           , 'flx' , '.X.FMEAN_NEE'              ,     1,     1; ...
   ...
   ...
   'hourly' , 'NEE_Iso'       , 'flx' , '.X.FMEAN_NEE_ISO'          ,     1,     0; ...
   'hourly' , 'NEE_Iso_Day'   , 'flx' , '.X.FMEAN_NEE_ISO_Night'    ,     1,     0; ...
   'hourly' , 'NEE_Iso_Night' , 'flx' , '.X.FMEAN_NEE_ISO_Day'      ,     1,     0; ...
   ...
   'hourly' , 'NEE_d13C'      , 'flx' , '.X.FMEAN_NEE_d13C'         ,     1,     1; ...
   'hourly' , 'NEE_d13C_Day'  , 'flx' , '.X.FMEAN_NEE_d13C_Night'   ,     1,     1; ...
   'hourly' , 'NEE_d13C_Night', 'flx' , '.X.FMEAN_NEE_d13C_Day'     ,     1,     1; ...
   ...
   'hourly' , 'Soil_Resp'     , 'flx' , '.X.FMEAN_Soil_Resp'        ,     0,     0; ...   % DNE
   'hourly' , 'Soil_Resp_d13C', 'flx' , '.X.FMEAN_Soil_Resp_d13C'   ,     0,     0; ...   % DNE
   ...
   'daily'  , 'NEE'           , 'flx' , '.X.DMEAN_NEE'              ,     1,     1; ...
   'daily'  , 'NEE_Night'     , 'flx' , '.X.DMEAN_NEE_Night'        ,     0,     0; ...
   'daily'  , 'NEE_Day'       , 'flx' , '.X.DMEAN_NEE_Day'          ,     0,     0; ...   % DNE
   ...
   'daily'  , 'NEE_Iso'       , 'flx' , '.X.DMEAN_NEE_ISOFLX'       ,     1,     0; ...
   ...
   'daily'  , 'NEE_d13C'      , 'flx' , '.X.DMEAN_NEE_d13C'         ,     1,     1; ...
   ...
   'daily' , 'Soil_Resp'      , 'flx' , '.X.DMEAN_Soil_Resp'        ,     0,     0; ...   % DNE
   'daily' , 'Soil_Resp_d13C' , 'flx' , '.X.DMEAN_Soil_Resp_d13C'   ,     1,     1; ...
   ...
   'monthly', 'NEE'           , 'flx' , '.X.MMEAN_NEE'              ,     1,     1; ...
   'monthly', 'NEE_Night'     , 'flx' , '.X.MMEAN_NEE_Night'        ,     0,     0; ...
   'monthly', 'NEE_Day'       , 'flx' , '.X.MMEAN_NEE_Day'          ,     0,     0; ...   % DNE
   ...
   'monthly', 'NEE_Iso'       , 'flx' , '.X.MMEAN_NEE_ISOFLX'       ,     1,     0; ...
   ...
   'monthly', 'NEE_d13C'      , 'flx' , '.X.MMEAN_NEE_d13CFLX'      ,     1,     1; ...
   ...
   'yearly' , 'NEE'           , 'flx' , '.X.YMEAN_NEE'              ,     1,     1; ...
   'yearly' , 'NEE_Night'     , 'flx' , '.X.YMEAN_NEE_Night'        ,     0,     0; ...
   'yearly' , 'NEE_Day'       , 'flx' , '.X.YMEAN_NEE_Day'          ,     0,     0; ...   % DNE
   ...
   'yearly' , 'NEE_Iso'       , 'flx' , '.X.YMEAN_NEE_ISOFLX'       ,     1,     0; ...
   ...
   'yearly' , 'NEE_d13C'      , 'flx' , '.X.YMEAN_NEE_d13C'         ,     1,     1; ...
   ...
   ...
   ...
...
if strcmp(model,'Rosenbrock')
   params = {... Name   ,   Initial Value  ,  Sdev,    Rng, Msk
                  ...
                  'x3'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x4'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x5'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x6'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x7'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x8'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x8'  , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x10' , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x11' , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x12' , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x13' , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
                  'x14' , (rand() - 0.5) *6,  0.5 , [-3,3], 1; ...
            };
end
%------------------------------------------------------------------------------------------%
