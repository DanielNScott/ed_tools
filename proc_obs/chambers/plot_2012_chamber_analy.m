function [] = plot_2012_chamber_analy(CO2_all, sdev_all, ave, hr_nobs, dates)
% plot_2012_chamber_analy(CO2_all, sdev_all, ave, hr_nobs, dates) takes arguments stored in
% "2012_chamber_analy_proc.mat" and produces a suite of figures summarizing the 2012 chamber
% data from Harvard Forest.
